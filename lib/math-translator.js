...
function getDecNumberRegexString(lang, capture) {
  ...
  var integerPart = "-?" + dig + "+|-?\\\\(?:" + katexColorMacros + ")[A-Z]?\\{-?" + dig + "+\\}";
  ...
  var wrappedDecimal = "\\\\(?:" + katexColorMacros + ")[A-Z]?\\{-?" + dig + "+" + sep + dig + "+\\}";
...
function getOrderedPairRegexString(lang) {
  ...
  var decimal = getDecNumberRegexString(lang, /* don't include capture groups */false);

  // Match 'a', '2' or '2a'
  var fracArgument = "(?:" + variable + "|(?:" + integer + ")(?:" + variable + ")?)";
